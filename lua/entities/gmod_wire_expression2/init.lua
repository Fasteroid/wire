...
function ENT:Execute(script, context)
	...
	if IsValid( selfTbl.player ) then
		self.player.e2_ops_total = (self.player.e2_ops_total or 0) + context.prf
		self.player.e2_cpu_total = (self.player.e2_cpu_total or 0) + context.timebench
	end
